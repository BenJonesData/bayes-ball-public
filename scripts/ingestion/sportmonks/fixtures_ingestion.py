...
from scripts.ingestion.sportmonks.config import BASE_URL, HEADERS, SAVE_LOCATION
from scripts.ingestion.sportmonks.league_codes_ingestion import get_leagues
